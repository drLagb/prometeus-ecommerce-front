...
export function ProductNotificationLoading() {
  return (
    <li
      className="list-none w-full md:w-pc-screen-mv h-mv-icon-l md:h-pc-icon-l bg-backgroundColor rounded-2xl"
      role="listitem"
    >
      <div className="w-full h-mv-icon-l md:h-pc-icon-l flex items-center">
        <div className="flex basis-full" role="separator">
          ...
          >
            <div
              className="rounded-full w-mv-icon-m h-mv-icon-m md:w-pc-icon-m md:h-pc-icon-m overflow-hidden bg-altBAckgroundColor animate-pulse duration-2000"
              role="none"
            ></div>
          </div>
          <div className="basis-5/6 px-2" role="separator">
            <div className="w-[49vw] h-[3vh] sm:h-[5vh] md:w-[16.5vw] md:h-[3vh] bg-mainColor rounded-xl animate-pulse delay-2000 duration-2000"></div>
          </div>
        </div>
      </div>
    </li>
...
export function ProductNotification({
  ...
  return (
    <li
      className={
        "list-none " +
        "w-full md:w-pc-screen-mv h-mv-icon-l md:h-pc-icon-l bg-backgroundColor rounded-2xl"
      }
      role="listitem"
    >
      <Link
        href={URL}
        className="w-full h-mv-icon-l md:h-pc-icon-l flex items-center"
        role="link"
      >
        <div className="flex basis-full" role="separator">
          <div
          ...
          >
            <div
              className="rounded-full w-mv-icon-m h-mv-icon-m md:w-pc-icon-m md:h-pc-icon-m overflow-hidden"
              role="none"
            >
              <img
                className="w-full"
          ...
          <div
            className="basis-5/6 flex justify-center items-center px-2"
            role="separator"
          >
            <div className="basis-1/2" role="separator">
              <h4 className="text-mainColor pb-2" role="presentation">
                {getProduct.nombre}
              </h4>
              <div
                className="flex items-center justify-between p-8 pb-0 py-0"
                role="separator"
              >
            ...
            <div className="basis-1/2 flex items-center justify-end pr-5">
              <p>
                ...
                {minutes > 0 ? `${Math.ceil(minutes)} min` : ""}
              </p>
            </div>
          </div>
        </div>
